...
@section('content')
    <div class="page-content bg-white">
        ...
        <div class="section-area section-sp1 ovpr-dark bg-fix online-cours"
            style="background-image:url({{ URL('images/background/bg1.jpg') }});">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center text-white">
                        <h2>Online Courses To Learn</h2>
                        <h5>Own Your Feature Learning New Skills Online</h5>
                        <form class="cours-search" action="{{ URL('courses') }}" method="GET">
                    ...
                    <div class="row">
                        <div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                            <div class="item">
                                <div class="cours-bx">
                                    <div class="action-box">
                                        <img src="{{ URL('images/courses/pic1.jpg') }}" alt="">
                            ...
                            <div class="item">
                                <div class="cours-bx">
                                    <div class="action-box">
                                        <img src="{{ URL('images/courses/pic2.jpg') }}" alt="">
                                        <a href="{{ URL('course_details') }}" class="btn">Read More</a>
                                    </div>
                                    <div class="info-bx text-center">
                                        <h5><a href="{{ URL('course_details') }}">Introduction EduChamp – LMS plugin</a></h5>
                            ...
                            <div class="item">
                                <div class="cours-bx">
                                    <div class="action-box">
                                        <img src="{{ URL('images/courses/pic3.jpg') }}" alt="">
                                        <a href="{{ URL('course_details') }}" class="btn">Read More</a>
                                    </div>
                                    <div class="info-bx text-center">
                                        <h5><a href="{{ URL('course_details') }}">Introduction EduChamp – LMS plugin</a></h5>
                            ...
                            <div class="item">
                                <div class="cours-bx">
                                    <div class="action-box">
                                        <img src="{{ URL('images/courses/pic4.jpg') }}" alt="">
                                        <a href="{{ URL('course_details') }}" class="btn">Read More</a>
                                    </div>
                                    <div class="info-bx text-center">
                                        <h5><a href="{{ URL('course_details') }}">Introduction EduChamp – LMS plugin</a>
                                        </h5>
                                        <span>Programming</span>
                                    </div>
                                    <div class="cours-more-info">
                        ...
                        <div class="col-md-12">
                            <div class="join-content-bx text-white">
                                ...
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                    ...
                                    specimen book.</p>
                                <a href="{{ URL('courses') }}" class="btn button-md">Join Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="feature-container">
                                        <div class="feature-md text-white m-b20">
                                            <a href="#" class="icon-cell"><img
                                                    src="{{ URL('images/icon/icon1.png') }}" alt=""></a>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 m-b30">
                                    <div class="feature-container">
                                        <div class="feature-md text-white m-b20">
                                            <a href="#" class="icon-cell"><img
                                                    src="{{ URL('images/icon/icon2.png') }}" alt=""></a>
                                        </div>
                                        <div class="icon-content">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 m-b30">
                                    <div class="feature-container">
                                        <div class="feature-md text-white m-b20">
                                            <a href="#" class="icon-cell"><img
                                                    src="{{ URL('images/icon/icon3.png') }}" alt=""></a>
                                        </div>
                                        <div class="icon-content">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 m-b30">
                                    <div class="feature-container">
                                        <div class="feature-md text-white m-b20">
                                            <a href="#" class="icon-cell"><img
                                                    src="{{ URL('images/icon/icon4.png') }}" alt=""></a>
                                        </div>
                                        <div class="icon-content">
                                            <h5 class="ttr-tilte">Our Philosophy</h5>
                                            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing.</p>
